...
public final class RecordAccumulator {
            ...
            synchronized (deque) {
                ...
                if (batch != null) {
                    ...
                    if (leader == null) {
                        ...
                        boolean flushInProgress = flushInProgress();
                        boolean sendable = full || expired || exhausted || closed || flushInProgress;
                        if (sendable && !backingOff) {
                            log.warn("Batch is sendable because full={} || expired={} || exhausted={} || closed={} || flushInProgress={}", full, expired, exhausted, closed, flushInProgress);
    ...
    public void beginFlush() {
        int flushes = this.flushesInProgress.getAndIncrement();
        log.warn("beginFlush(): {} -> {}", flushes, flushes + 1, new Exception());
    }
    ...
    public void awaitFlushCompletion() throws InterruptedException {
        try {
            ...
            int flushes = this.flushesInProgress.decrementAndGet();
            log.warn("awaitFlushCompletion(): {} -> {}", flushes + 1, flushes, new Exception());
        }
    }
